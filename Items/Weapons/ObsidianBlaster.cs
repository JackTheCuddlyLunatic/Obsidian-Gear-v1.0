...
using ObsidianGear.Items;

namespace ObsidianGear.Items.Weapons
{
	public class ObsidianBlaster : ModItem
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("It's an over-under shotgun made with obsidian.");
		}
		...
		public override void SetDefaults()
		{
			...
			item.value = Item.sellPrice(0, 4, 50, 0); // how much the item sells for (measured in copper)
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(ModContent.ItemType<ObsidianIngot>(), 8);
			...
			modRecipe.AddIngredient(ModContent.ItemType<ObsidianBlaster>(), 1);
			modRecipe.AddIngredient(ItemID.SoulofNight, 10);
			modRecipe.AddIngredient(ItemID.DarkShard, 2);
			modRecipe.AddTile(TileID.MythrilAnvil);
			modRecipe.SetResult(ItemID.OnyxBlaster);
			modRecipe.AddRecipe();
		}
