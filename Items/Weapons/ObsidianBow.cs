...
namespace ObsidianGear.Items.Weapons
{
	class ObsidianBow : ModItem
	{
		public override void SetDefaults()
		{
			...
			item.value = Item.sellPrice(0, 0, 46, 0); // how much the item sells for (measured in copper)
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(ModContent.GetInstance<ObsidianIngot>(), 15);
